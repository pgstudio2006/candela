...
import {
  deleteAdminPatientAction,
  getAdminPatientHistoryAction,
...
export default function AdminPatientDetailPage() {
  ...
  const [history, setHistory] = useState<AdminPatientHistory | null>(null);
  ...
  if (loading) {
    return (
      <PageChrome breadcrumbs={[{ label: "Admin", href: "/app/admin" }, { label: "Patients" }]} title="Loading…">
        <p className="text-[13px] text-[var(--attio-text-tertiary)]">Loading patient record…</p>
      </PageChrome>
    );
  }
